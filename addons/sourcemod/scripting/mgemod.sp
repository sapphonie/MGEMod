...
// ====[ VARIABLES ]===================================================
// Handle, char, float, bool, NUM, TFCT
bool g_bNoStats;
bool g_bNoDisplayRating;

// HUD Handles
Handle hm_HP;
Handle hm_Score;
Handle hm_TeammateHP;
Handle hm_KothTimerBLU;
Handle hm_KothTimerRED;
Handle hm_KothCap;
...
bool g_bUseSQLite;
bool g_bAutoCvar;
int g_iDefaultFragLimit;
int g_iAirshotHeight = 80;
char g_spawnFile[128];

// Database
Handle db                       = INVALID_HANDLE; // Connection to SQL database.
Handle g_hDBReconnectTimer      = INVALID_HANDLE;
char g_sDBConfig[64];
int g_iReconnectInterval;

// Global CVar Handles
Handle gcvar_WfP                = INVALID_HANDLE;
...
int g_iArenaCount;
int g_fTotalTime[MAXARENAS+1];
int g_iCappingTeam[MAXARENAS+1];
float g_fCappedTime[MAXARENAS+1];
int g_iCapturePoint[MAXARENAS+1];
int g_iDefaultCapTime[MAXARENAS+1];
int g_iKothTimer[MAXARENAS+1][4];           // [what arena is the cap point in][Team Red or Team Blu Time left]
int g_iPointState[MAXARENAS+1];             //1 = neutral, 2 = RED, 3 = BLU
int g_iArenaScore[MAXARENAS+1][3];
int g_iArenaQueue[MAXARENAS+1][MAXPLAYERS+1];
int g_iArenaStatus[MAXARENAS+1];
int g_iArenaCd[MAXARENAS+1];                //countdown to round start
int g_iArenaFraglimit[MAXARENAS+1];
int g_iArenaMinRating[MAXARENAS+1];
int g_iArenaMaxRating[MAXARENAS+1];
int g_iArenaCdTime[MAXARENAS+1];
int g_iArenaSpawns[MAXARENAS+1];
int g_iBBallHoop[MAXARENAS+1][3];           // [What arena the hoop is in][Hoop 1 or Hoop 2]
int g_iBBallIntel[MAXARENAS+1];
int g_iArenaEarlyLeave[MAXARENAS+1];
int g_iELOMenuPage[MAXARENAS+1];
int g_tfctArenaAllowedClasses[MAXARENAS+1][TFClassType]; // Special "TFClass_Type" data type.
